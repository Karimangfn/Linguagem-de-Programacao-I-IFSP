		...
		if (opcao == 1) {
		  System.out.println("Voce é uma Pessoa Fisica[PF] ou uma Pessoa Juridica[PJ]?");
		  	...
		  	if (N.equals("PF")) {
		  			...
		  			VetorPF[contador].setEndereço(Scan.next());
		  			Scan.nextLine(); //Limpar Buffer
		  		    ...
		  		    System.out.println("Sua Razão Social: ");
	  			    ...
	  			    System.out.println("Digite seu Endereço: ");
	  			    Scan.nextLine(); //Limpar Buffer
	  			    VetorPJ[contador2].setEndereço(Scan.next());
	  			    System.out.println("Digite seu Telefone: ");
			...
			for(contador3=0; contador3 < contador; contador3++) {
				...
				System.out.println("Endereco: " + VetorPF[contador3].getEndereço());
			...
			for(contador3=0; contador3 < contador2; contador3++) {
                ...
                System.out.println("Endereco: " + VetorPJ[contador3].getEndereço());
