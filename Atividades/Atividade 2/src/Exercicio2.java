public class Exercicio2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nLetra C"); // Letra C)
        Texto = Texto.replace("Crispim Soares", "CRISPIM SOARES");
        System.out.println(Texto);
        ...
        System.out.println("Quantas vezes aparece a palavra 'não': " + contador);
        ...
        System.out.println("Quantidade de espaços que o texto possui: " + (Texto.length() - Texto2.length()));
    }
}