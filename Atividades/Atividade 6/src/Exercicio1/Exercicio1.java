...
public class Exercicio1 {
    ...
    public static void main(String[] args) {
         ...
         case 5:
             System.out.println("Digite a Posição do Produto Que Você Quer Substituir: ");
             posicao = Scan.nextInt();
             System.out.println("Digite o Nome do Produto que Você Quer Substituir: ");
             Scan.nextLine();
             elemento = Scan.nextLine();
         ...
         case 7:
             System.out.println("Digite a Posição do Produto que você quer Remover");
             posicao = Scan.nextInt();
